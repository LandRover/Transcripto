...
def cli_mode():
    ...
    parser.add_argument("--summarization_engine", type=str, default="vertex", help="summarization engine")
    parser.add_argument("--summarization_model", type=str, default="gemini-3-pro-preview", help="summarization model")
